...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=$(FEATH_CONFIG_APP_NAME) \
		  ...
		  -X github.com/KendrickAng/mychain/app.AppName=$(FEATH_CONFIG_APP_NAME) \
		  -X github.com/KendrickAng/mychain/app.AccountAddressPrefix=$(FEATH_CONFIG_ACC_ADDR_PREFIX) \
		  -X github.com/KendrickAng/mychain/app.AccountPubKeyPrefix=$(FEATH_CONFIG_ACC_PUBKEY_PREFIX) \
		  -X github.com/KendrickAng/mychain/app.ValidatorAddressPrefix=$(FEATH_CONFIG_VALIDATOR_ADDRESS_PREFIX) \
		  -X github.com/KendrickAng/mychain/app.ValidatorPubKeyPrefix=$(FEATH_CONFIG_VALIDATOR_PUBKEY_PREFIX) \
		  -X github.com/KendrickAng/mychain/app.ConsensusNodeAddressPrefix=$(FEATH_CONFIG_CONS_NODE_ADDR_PREFIX) \
		  -X github.com/KendrickAng/mychain/app.ConsensusNodePubKeyPrefix=$(FEATH_CONFIG_ACC_PUBKEY_PREFIX) \
		  -X github.com/KendrickAng/mychain/app.BondDenom=$(FEATH_CONFIG_BOND_DENOM)
